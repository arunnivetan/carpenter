...
export default function VisitConfirmModal({ isOpen, onClose, onSubmit, visitIndex, defaultDate }) {
          ...
          <div className="space-y-3">
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full bg-[#FAF6F0]/60 border border-[#E6D4C0] rounded-xl px-3.5 py-2.5 text-xs font-bold text-[#4A3E3D]"
              />
            </div>
